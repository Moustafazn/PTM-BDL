...
def _init(case_study: str):
    ...
    RAW_DIR = PROJECT_ROOT / cfg["paths"]["raw_data"] / "pdb"
    OUT_DIR = PROJECT_ROOT / cfg["paths"]["processed_data"] / "pdb"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Step 03 — Download structures")
