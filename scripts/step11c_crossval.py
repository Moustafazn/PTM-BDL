...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  STEP 11c — Stratified K-Fold Cross-Validation (PTM-BDL, 2026-06-28)        ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
...
from src.models.multimodal_predictor import PROTEIN_ID_ERBB2  # noqa: E402
...
# ══════════════════════════════════════════════════════════════════════════════
# Site labels (same as step11b — kept locally so step11c is standalone)
# ══════════════════════════════════════════════════════════════════════════════
...
def _run_ig_per_mod_type(model, dataset, indices, n_steps: int = 20):
    ...
    (revised 2026-07-03 — matches step11b/step13 4-channel IG):
      ...
      - glyco_vector      (glyco level, baseline=1.0 = WT)
      - delta_glyco_vector (drug-induced glyco change, baseline=0.0)
    ...
    for idx in indices:
        ...
        a_gl = sample["glyco_vector"]
        a_dph = sample["delta_ptm_vector"]
        a_dgl = sample["delta_glyco_vector"]
